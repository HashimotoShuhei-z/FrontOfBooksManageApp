    ...
    <main className="w-screen h-screen">
      <div className="w-screen h-screen mx-auto lg:py-16 lg:grid-cols-2 gap-8 lg:gap-16">
        <div className="w-96 h-120 p-6 space-y-4 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800 mx-auto mt-6">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white text-center">社員新規登録</h2>
          <form className="mt-8 space-y-4" action="#">
            ...
            <div>
              <label htmlFor="adminPassword" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                AdminPassword
              </label>
              <input
                type="password"
            ...
            <div className="flex justify-center">
              <Button asChild>
                <Link href="/user/home" className="font-semibold">
                  登録
                </Link>
              </Button>
            </div>
